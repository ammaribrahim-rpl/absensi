...
// Hak akses dibatasi: Admin tidak diizinkan melihat status/keterangan izin/cuti karyawan
echo "<script>alert('Akses Dibatasi: Data keterangan karyawan hanya dapat diakses oleh Owner.'); window.location.href='admin.php';</script>";
exit;
?>
<!DOCTYPE html>
<html lang="id">
