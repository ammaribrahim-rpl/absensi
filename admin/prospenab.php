...
<head>
    ...
    <title>Hasil Pencarian Absen — Absensi</title>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <div>
                                <h4 class="font-weight-bold mb-0 text-dark">Hasil Pencarian Absensi</h4>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="card p-3">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    <h5 class="font-weight-bold text-dark mb-0">Hasil Pencarian: "<em><?= htmlspecialchars($cari) ?></em>"</h5>
                                </div>
                                <a href="data_absen.php" class="btn btn-sm btn-outline-secondary">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php 
                                        $cari_param = '%' . $cari . '%';
                                        $stmt = mysqli_prepare($koneksi, "SELECT * FROM tb_absen WHERE id_karyawan LIKE ? OR nama LIKE ? ORDER BY id DESC");
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-center py-4 text-muted">
                                                <i class="fas fa-info-circle mr-1"></i> Tidak ditemukan log absen dengan kata kunci "<?= htmlspecialchars($cari) ?>"
                                            </td>
                                        </tr>
                                        <?php
                                        endif;
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="../absen/hapus_absen.php?id=<?= urlencode($row['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?');">
